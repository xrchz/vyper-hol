...
val final_codegen_defs =
  [alistTheory.fmap_to_alist_FEMPTY,
   ...
   stackPlanTypesTheory.operand_to_string_def,
   stackPlanTypesTheory.is_var_operand_def,
   stackPlanTypesTheory.is_label_operand_def,
   ...
   stackModelTheory.stack_get_phi_depth_def,
   ...
   dfgDefsTheory.dfg_get_uses_def,
   dfgDefsTheory.dfg_get_def_def,

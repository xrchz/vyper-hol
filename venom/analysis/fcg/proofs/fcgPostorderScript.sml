...
Theorem reachable_fcg_acyclic_edge_case_evaluations:
  reachable_fcg_acyclic fcg_postorder_test_ctx
    fcg_postorder_acyclic_test_fcg /\
  ~reachable_fcg_acyclic fcg_postorder_test_ctx
    fcg_postorder_self_cycle_test_fcg /\
  ~reachable_fcg_acyclic fcg_postorder_test_ctx
